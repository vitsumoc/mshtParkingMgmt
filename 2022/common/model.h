...
public:
    ...
    void toQuery(QSqlQuery *query) const {
        query->prepare("INSERT INTO owners (code, room_code, name, phone, plate1, plate2, status, parking_id, r1, r2) "
                      "VALUES (:code, :room_code, :name, :phone, :plate1, :plate2, :status, :parking_id, :r1, :r2)");
        query->bindValue(":code", code);
